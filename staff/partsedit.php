...
<style>
/* -- Same layout structure as admin -- */
.center-container {
    width: 80%;
    max-width: 1200px;
    margin: 0 auto;
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="image-preview">
                        <?php
                        // Check if Media is an array or a single path
...
function validateAllFields() {
    ...
    // If not requiring new image on every edit, remove or tweak this:
...
// Cancel & go back
function cancelEdit() {
    // Or redirect wherever you prefer
    window.history.back();
}
