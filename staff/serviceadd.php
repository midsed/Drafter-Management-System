...
// Set session info for later use
...
<style>
    ...
    .center-container {
        width: 80%;
        max-width: 1200px;
        margin: 40px auto; /* 40px top spacing, auto center horizontally */
        background: white;
        padding: 20px;
        border-radius: 8px;
    ...
    /* Grid layout: three columns per row, etc. */
    .form-row {
        display: flex;
        flex-wrap: wrap;
        gap: 15px;
...
<div class="main-content">
    ...
    <div class="center-container">
        <form id="service-form" action="" method="POST">
            <!-- Row 1: Part Name, First Name, Last Name -->
            <div class="form-row">
            ...
            <!-- Row 2: Email, Phone, Service Type -->
            <div class="form-row">
                <div class="form-group">
            ...
            <!-- Row 3: Price alone (or you can group more fields if needed) -->
            <div class="form-row">
                <div class="form-group">
...
// Validation scripts (same as Admin version):
function validateNameField(fieldId, errorId, fieldName) {
    const field = document.getElementById(fieldId);
    const errorElem = document.getElementById(errorId);
    const pattern = /^[A-Za-z\s]+$/; // letters/spaces only
...
function validatePhoneField(fieldId, errorId) {
    ...
    // Enforce digit-only and "09" prefix
...
function resetForm() {
    Swal.fire({
        title: "Are you sure?",
        text: "This will reset all information.",
        icon: "warning",
...
// Initialize validations on DOM load
document.addEventListener("DOMContentLoaded", function() {
