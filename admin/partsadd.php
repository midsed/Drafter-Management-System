...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bind_param("sdssissssssssi", $name, $price, $make, $model, $year_model, $description, $authenticity, $category, $condition, $status, $date_added, $last_updated, $media, $user_id);
    
    if ($stmt->execute()) {
        echo "<script>alert('Part added successfully!'); window.location.href = 'parts.php';</script>";
    } else {
        echo "<script>alert('Error adding part: " . $stmt->error . "');</script>";
    }
