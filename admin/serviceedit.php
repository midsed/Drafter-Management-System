    ...
    <div class="center-container">
        <form action="serviceedit_process.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="fName" name="fName" value="<?php echo htmlspecialchars($service['FName'] ?? ''); ?>" required>
            </div>

            <div class="form-group">
                <label for="lName">Customer Last Name:</label>
                <input type="text" id="lName" name="lName" value="<?php echo htmlspecialchars($service['LName'] ?? ''); ?>" required>
            </div>

            <div class="form-group">
                <label for="client_email">Customer Email:</label>
                <input type="email" id="client_email" name="client_email" value="<?php echo htmlspecialchars($service['ClientEmail']); ?>" required>
            </div>

            <div class="form-group">
                <label for="pNumber">Customer Phone Number:</label>
                <input type="number" id="pNumber" name="pNumber" value="<?php echo htmlspecialchars($service['PhoneNumber'] ?? ''); ?>" required maxlength="11">
            </div>

            <div class="form-group">
                <label for="type">Service Type:</label>
                <input type="text" id="type" name="type" value="<?php echo htmlspecialchars($service['Type']); ?>" required oninput="checkPartMatch()">
            </div>

            <div class="form-group">
                <label for="price">Service Price:</label>
                <input type="number" id="price" name="price" value="<?php echo htmlspecialchars($service['Price']); ?>" required>
            </div>
